...
const seedReviews = [
  {
    ...
    story: [
      "We were sceptical. We had tried a freelance VA before and it ended in missed calls and garbled emails, so the bar for Westbridge was high. Our discovery call changed the tone completely — within five days we had three candidate videos, and each one spoke clearer, more confident English than some of the people we had interviewed locally.",
  ...
  },
  {
    ...
    story: [
      "As a bootstrapped founder, I was doing customer emails at midnight and calling that a strategy. I gave Westbridge the smallest possible brief: a part-time administrator, 20 hours a week, to take over my inbox and order admin. Within a month I had my evenings back.",
      "The part-time test is what sold me on the model. There was no pressure to scale, no pushy account manager — but once I saw the quality, scaling was the obvious move. Today our Westbridge team handles all customer service, our email marketing, and back-office admin. Five people, one invoice, roughly $5,700 a month.",
  ...
  },
  {
    ...
    story: [
      "Professional services firms live and die on staying visible, but a mid-weight marketing hire in Sydney was quoting A$85k plus super. We could not justify it, so marketing simply was not getting done. Westbridge presented three candidates within a week, all with genuine HubSpot and WordPress experience.",
      "We chose Katrina, and the onboarding genuinely was painless. Westbridge had her set up on managed equipment with our VPN and 2FA policies before day one. By the end of week two she owned our email calendar, LinkedIn presence and monthly newsletter. I review; she executes.",
      "A year in, we added an executive assistant through Westbridge as well. Combined, the two roles cost us about A$3,700 a month against a realistic A$9,800 locally — and the standard has never once felt like a compromise. I tell every firm owner I know: this is the easiest margin improvement you will ever make.",
    ],
    photo: "/images/avatars/michael.svg",
    status: "published" as const,
    sortOrder: 3,
  },
  {
    ...
    quote:
      "Tenancy paperwork, invoicing, bank recs — it all just happens now. Our two Westbridge administrators are the most dependable people in the business.",
    story: [
      ...
      "Westbridge placed two administrators and a bookkeeper with us over about six weeks. The difference from our previous outsourcing experience is the management layer — their team leaders check quality before we ever see an issue, and the monthly reporting means I always know what got done.",
  ...
  },
  {
    ...
    quote:
      "Tax season used to mean turning away work. This year our two Westbridge bookkeepers cleared the backlog — and their Xero and QuickBooks skills were better than advertised.",
    story: [
      ...
      "We started with one bookkeeper during tax season as a trial. The work came back clean, coded correctly, and on deadline. We now have two bookkeepers and an executive assistant through Westbridge, all working US Central hours, all inside our practice management software under our security policies.",
    ...
    photo: "/images/avatars/david.svg",
    status: "published" as const,
    sortOrder: 5,
  },
  {
