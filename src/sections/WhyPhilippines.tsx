...
const features = [
  ...
  },
  {
    ...
    text: 'A well-established night-shift culture built on serving western markets means your team works your business day — UK, US, Canadian, Australian or New Zealand time.',
  },
  {
    icon: GraduationCap,
