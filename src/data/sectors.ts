...
export const sectors: Sector[] = [
  ...
  },
  {
    ...
    savingsNote:
      'Two native administrators cost around £5,600 (US$7,800 / A$10,600) per month fully loaded. The same two seats through Ticky cost from roughly £2,170 / US$2,750 — an annual saving that can exceed £40,000 per branch.',
    caseStudy: {
  ...
  },
  {
    ...
    exampleRoles: [
      ...
      { roleId: 'social', note: 'Content calendars, Canva graphics and community management' },
    ],
    savingsNote:
  ...
  },
  {
    ...
    exampleRoles: [
      ...
      { roleId: 'marketing', note: 'Email campaigns, SEO updates and client reporting' },
      { roleId: 'admin', note: 'Traffic management, deck formatting and account admin' },
    ],
    savingsNote:
      'A native social media or content specialist costs around £3,200 (US$4,400 / A$6,000) per month fully loaded. Ticky specialists start from roughly £1,315 / US$1,660 — letting agencies add delivery capacity for less than half the local cost.',
    caseStudy: {
